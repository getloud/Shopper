...
public class HomeActivity extends Activity implements ScanditSDKListener
{
    ...
    private Button createCroppedOverlayButton(final RelativeLayout rootView) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mBarcodePicker = new ScanditSDKBarcodePicker(HomeActivity.this, sScanditSdkAppKey);
